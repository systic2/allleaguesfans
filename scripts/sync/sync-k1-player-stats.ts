/**
 * Sync K League 1 Player Statistics from Highlightly
 */

import { createClient } from '@supabase/supabase-js';

// Use environment variables directly (no dotenv - already loaded by shell)
...
async function syncPlayerStats() {
  console.log('🚀 K League 1 선수 통계 동기화 시작\n');
