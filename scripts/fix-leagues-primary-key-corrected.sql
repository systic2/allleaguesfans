-- fix-leagues-primary-key-corrected.sql
-- Safe migration to fix leagues table primary key structure (SYNTAX CORRECTED)
...
-- =====================================================
-- STEP 2: Show and Remove Duplicates (if any)
-- =====================================================
...
-- =====================================================
-- STEP 3: Create Backup and Fix Primary Key
-- =====================================================
...
BEGIN
    ...
    SELECT COUNT(*) INTO backup_count FROM leagues_backup_before_pk_fix;
    RAISE NOTICE '✅ Created backup table with % records: leagues_backup_before_pk_fix', backup_count;
    ...
    ELSE
        RAISE NOTICE '⚠️ No existing primary key found';
    END IF;
...
-- =====================================================
-- STEP 5: Fix Player Statistics Foreign Key
-- =====================================================
...
BEGIN
    ...
    ELSE
        ...
        RAISE NOTICE 'Check the primary key manually and retry if needed.';
    END IF;
END $$;